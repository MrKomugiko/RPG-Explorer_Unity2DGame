...
{    
    ...
    public int Level { get => _level; set { _level = value; _playerStatsIsChanged = true; } }
    ...
    public int Dexterity { get => _dexterity; set { _dexterity = value; _playerStatsIsChanged = true;
        }
    }
    public int Inteligence { get => _inteligence; set { _inteligence = value; _playerStatsIsChanged = true;
        }
    }
    public int Agility { get => _agility; set { _agility = value; _playerStatsIsChanged = true;
        }
    }

    public int Vitality { get => _vitality; set { _vitality = value; _playerStatsIsChanged = true;
        }
    }
